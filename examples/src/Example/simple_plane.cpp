...
cSimplePlaneEKF::cSimplePlaneEKF()
{
	setDim(4, 1, 2, 2, 2);
	Period = 0.2;
	Gravity = 9.8;
...
void cSimplePlaneEKF::makeProcess()
{
	SimpleVector x_(x.size());
...
void cSimplePlaneEKF::makeMeasure()
{
	z(1)=atan2(x(3), x(1));
